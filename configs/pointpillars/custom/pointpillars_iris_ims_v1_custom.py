...
point_cloud_range = [-92, -19.84, -4, 100, 19.84, 5]  
anchor_range = [-92, -19.84, -1.5, 100, 19.84, -1.5]
anchor_size  = [5, 2, 1.5]
output_shape = [
...
data_root = '/mnt/ssd/Datasets/DatasetForTraining/IRIS_IMS_v1/'
batch_size = 2
times = 1
class_names = ['Car']
